...
function Chapter2({user,num}) {
  return (
    <div>
        ...
        fourPicsAnswer={'awit'}
        summary={'Nagkaroon ng malubhang karamdaman si Don Fernando buhat sa isang bangungot. Sa kaniyang panaginip ay nakita niya ang bunsong anak na si Don Juan na pinaslang ng dalawang buhong at inihulog sa malalim na balon. Dahil sa pag-aalala ay hindi na nakatulog at nakakain ng maayos ang hari magmula noon hanggang sa ito’y maging buto’t-balat na. \n\nMaging ang asawa at mga anak ng Don ay nabahala na din dahil walang sinuman ang makapagbigay ng lunas sa sakit ng hari. Isang medikong paham ang dumating sa kaharian na naghayag na ang tanging lunas sa sakit ng hari ay ang awit ng isang ibon na makikita sa bundok ng Tabor sa may kumikinang na puno ng Piedras Platas.\n\n Ang ibon na ito ay matatagpuan lamang tuwing gabi dahil ito ay nasa burol tuwing araw. Nang malaman ang tungkol sa lunas ay agad nag-utos ang pinuno ng monarka sa panganay na si Don Pedro upang hanapin at hulihin ang Ibong Adarna.'}
        num={num}
         />
    </div>
  )
